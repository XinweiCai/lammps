...
DumpCustomNotag::DumpCustomNotag(LAMMPS *lmp, int narg, char **arg) :
  Dump(lmp, narg, arg),
...
DumpCustomNotag::~DumpCustomNotag()
{
...
void DumpCustomNotag::init_style()
{
  ...
  if (binary && domain->triclinic == 0)
    header_choice = &DumpCustomNotag::header_binary;
  else if (binary && domain->triclinic == 1)
    header_choice = &DumpCustomNotag::header_binary_triclinic;
  else if (!binary && domain->triclinic == 0)
    header_choice = &DumpCustomNotag::header_item;
  else if (!binary && domain->triclinic == 1)
    header_choice = &DumpCustomNotag::header_item_triclinic;

  if (binary) write_choice = &DumpCustomNotag::write_binary;
  else if (buffer_flag == 1) write_choice = &DumpCustomNotag::write_string;
  else write_choice = &DumpCustomNotag::write_lines;
...
void DumpCustomNotag::write_header(bigint ndump)
{
...
void DumpCustomNotag::header_binary(bigint ndump)
{
...
void DumpCustomNotag::header_binary_triclinic(bigint ndump)
{
  fwrite(&update->ntimestep,sizeof(bigint),1,fp);
  fwrite(&ndump,sizeof(bigint),1,fp);
  fwrite(&domain->triclinic,sizeof(int),1,fp);
...
///// only here is modified, sometime below is not needed
void DumpCustomNotag::header_item(bigint ndump)
{
...
void DumpCustomNotag::header_item_triclinic(bigint ndump)
{
  /*if (unit_flag && !unit_count) {
    ++unit_count;
    fprintf(fp,"ITEM: UNITS\n%s\n",update->unit_style);
...
void DumpCustomNotag::pack(tagint *ids)
{
...
int DumpCustomNotag::convert_string(int n, double *mybuf)
{
  int i,j;
...
void DumpCustomNotag::write_data(int n, double *mybuf)
{
...
void DumpCustomNotag::write_binary(int n, double *mybuf)
{
  n *= size_one;
...
void DumpCustomNotag::write_string(int n, double *mybuf)
{
...
void DumpCustomNotag::write_lines(int n, double *mybuf)
{
  int i,j;
...
int DumpCustomNotag::parse_fields(int narg, char **arg)
{
  // customize by adding to if statement
  ...
  for (int iarg = 0; iarg < narg; iarg++) {
    ...
    if (strcmp(arg[iarg],"id") == 0) {
      pack_choice[i] = &DumpCustomNotag::pack_id;
      if (sizeof(tagint) == sizeof(smallint)) vtype[i] = Dump::INT;
      else vtype[i] = Dump::BIGINT;
    } else if (strcmp(arg[iarg],"mol") == 0) {
      if (!atom->molecule_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpCustomNotag::pack_molecule;
      if (sizeof(tagint) == sizeof(smallint)) vtype[i] = Dump::INT;
      else vtype[i] = Dump::BIGINT;
    } else if (strcmp(arg[iarg],"proc") == 0) {
      pack_choice[i] = &DumpCustomNotag::pack_proc;
      vtype[i] = Dump::INT;
    } else if (strcmp(arg[iarg],"procp1") == 0) {
      pack_choice[i] = &DumpCustomNotag::pack_procp1;
      vtype[i] = Dump::INT;
    } else if (strcmp(arg[iarg],"type") == 0) {
      pack_choice[i] = &DumpCustomNotag::pack_type;
      vtype[i] = Dump::INT;
    } else if (strcmp(arg[iarg],"element") == 0) {
      pack_choice[i] = &DumpCustomNotag::pack_type;
      vtype[i] = Dump::STRING;
    } else if (strcmp(arg[iarg],"mass") == 0) {
      pack_choice[i] = &DumpCustomNotag::pack_mass;
      vtype[i] = Dump::DOUBLE;

    } else if (strcmp(arg[iarg],"x") == 0) {
      pack_choice[i] = &DumpCustomNotag::pack_x;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"y") == 0) {
      pack_choice[i] = &DumpCustomNotag::pack_y;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"z") == 0) {
      pack_choice[i] = &DumpCustomNotag::pack_z;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"xs") == 0) {
      if (domain->triclinic) pack_choice[i] = &DumpCustomNotag::pack_xs_triclinic;
      else pack_choice[i] = &DumpCustomNotag::pack_xs;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"ys") == 0) {
      if (domain->triclinic) pack_choice[i] = &DumpCustomNotag::pack_ys_triclinic;
      else pack_choice[i] = &DumpCustomNotag::pack_ys;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"zs") == 0) {
      if (domain->triclinic) pack_choice[i] = &DumpCustomNotag::pack_zs_triclinic;
      else pack_choice[i] = &DumpCustomNotag::pack_zs;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"xu") == 0) {
      if (domain->triclinic) pack_choice[i] = &DumpCustomNotag::pack_xu_triclinic;
      else pack_choice[i] = &DumpCustomNotag::pack_xu;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"yu") == 0) {
      if (domain->triclinic) pack_choice[i] = &DumpCustomNotag::pack_yu_triclinic;
      else pack_choice[i] = &DumpCustomNotag::pack_yu;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"zu") == 0) {
      if (domain->triclinic) pack_choice[i] = &DumpCustomNotag::pack_zu_triclinic;
      else pack_choice[i] = &DumpCustomNotag::pack_zu;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"xsu") == 0) {
      if (domain->triclinic) pack_choice[i] = &DumpCustomNotag::pack_xsu_triclinic;
      else pack_choice[i] = &DumpCustomNotag::pack_xsu;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"ysu") == 0) {
      if (domain->triclinic) pack_choice[i] = &DumpCustomNotag::pack_ysu_triclinic;
      else pack_choice[i] = &DumpCustomNotag::pack_ysu;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"zsu") == 0) {
      if (domain->triclinic) pack_choice[i] = &DumpCustomNotag::pack_zsu_triclinic;
      else pack_choice[i] = &DumpCustomNotag::pack_zsu;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"ix") == 0) {
      pack_choice[i] = &DumpCustomNotag::pack_ix;
      vtype[i] = Dump::INT;
    } else if (strcmp(arg[iarg],"iy") == 0) {
      pack_choice[i] = &DumpCustomNotag::pack_iy;
      vtype[i] = Dump::INT;
    } else if (strcmp(arg[iarg],"iz") == 0) {
      pack_choice[i] = &DumpCustomNotag::pack_iz;
      vtype[i] = Dump::INT;

    } else if (strcmp(arg[iarg],"vx") == 0) {
      pack_choice[i] = &DumpCustomNotag::pack_vx;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"vy") == 0) {
      pack_choice[i] = &DumpCustomNotag::pack_vy;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"vz") == 0) {
      pack_choice[i] = &DumpCustomNotag::pack_vz;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"fx") == 0) {
      pack_choice[i] = &DumpCustomNotag::pack_fx;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"fy") == 0) {
      pack_choice[i] = &DumpCustomNotag::pack_fy;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"fz") == 0) {
      pack_choice[i] = &DumpCustomNotag::pack_fz;
      vtype[i] = Dump::DOUBLE;

    } else if (strcmp(arg[iarg],"q") == 0) {
      if (!atom->q_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpCustomNotag::pack_q;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"mux") == 0) {
      if (!atom->mu_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpCustomNotag::pack_mux;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"muy") == 0) {
      if (!atom->mu_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpCustomNotag::pack_muy;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"muz") == 0) {
      if (!atom->mu_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpCustomNotag::pack_muz;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"mu") == 0) {
      if (!atom->mu_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpCustomNotag::pack_mu;
      vtype[i] = Dump::DOUBLE;

    } else if (strcmp(arg[iarg],"radius") == 0) {
      if (!atom->radius_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpCustomNotag::pack_radius;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"diameter") == 0) {
      if (!atom->radius_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpCustomNotag::pack_diameter;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"omegax") == 0) {
      if (!atom->omega_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpCustomNotag::pack_omegax;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"omegay") == 0) {
      if (!atom->omega_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpCustomNotag::pack_omegay;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"omegaz") == 0) {
      if (!atom->omega_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpCustomNotag::pack_omegaz;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"angmomx") == 0) {
      if (!atom->angmom_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpCustomNotag::pack_angmomx;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"angmomy") == 0) {
      if (!atom->angmom_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpCustomNotag::pack_angmomy;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"angmomz") == 0) {
      if (!atom->angmom_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpCustomNotag::pack_angmomz;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"tqx") == 0) {
      if (!atom->torque_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpCustomNotag::pack_tqx;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"tqy") == 0) {
      if (!atom->torque_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpCustomNotag::pack_tqy;
      vtype[i] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"tqz") == 0) {
      if (!atom->torque_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpCustomNotag::pack_tqz;
      vtype[i] = Dump::DOUBLE;
    ...
    // if no trailing [], then arg is set to 0, else arg is int between []
      ...
      pack_choice[i] = &DumpCustomNotag::pack_compute;
      vtype[i] = Dump::DOUBLE;
    ...
    // if no trailing [], then arg is set to 0, else arg is between []
      ...
      pack_choice[i] = &DumpCustomNotag::pack_fix;
      vtype[i] = Dump::DOUBLE;
    ...
    // variable value = v_name
      ...
      pack_choice[i] = &DumpCustomNotag::pack_variable;
      vtype[i] = Dump::DOUBLE;
    ...
    // custom per-atom floating point value = d_ID
      ...
      pack_choice[i] = &DumpCustomNotag::pack_custom;
      vtype[i] = Dump::DOUBLE;
...
int DumpCustomNotag::add_compute(char *id)
{
  int icompute;
...
int DumpCustomNotag::add_fix(char *id)
{
  int ifix;
...
int DumpCustomNotag::add_variable(char *id)
{
  int ivariable;
...
int DumpCustomNotag::add_custom(char *id, int flag)
{
  int icustom;
...
int DumpCustomNotag::modify_param(int narg, char **arg)
{
...
bigint DumpCustomNotag::memory_usage()
{
...
void DumpCustomNotag::pack_compute(int n)
{
...
void DumpCustomNotag::pack_fix(int n)
{
...
void DumpCustomNotag::pack_variable(int n)
{
...
void DumpCustomNotag::pack_custom(int n)
{
...
void DumpCustomNotag::pack_id(int n)
{
  tagint *tag = atom->tag;
...
void DumpCustomNotag::pack_molecule(int n)
{
  tagint *molecule = atom->molecule;
...
void DumpCustomNotag::pack_proc(int n)
{
  for (int i = 0; i < nchoose; i++) {
    buf[n] = me;
    n += size_one;
...
void DumpCustomNotag::pack_procp1(int n)
{
  for (int i = 0; i < nchoose; i++) {
    buf[n] = me+1;
    n += size_one;
...
void DumpCustomNotag::pack_type(int n)
{
  int *type = atom->type;
...
void DumpCustomNotag::pack_mass(int n)
{
  int *type = atom->type;
  double *mass = atom->mass;
...
void DumpCustomNotag::pack_x(int n)
{
  double **x = atom->x;
...
void DumpCustomNotag::pack_y(int n)
{
  double **x = atom->x;
...
void DumpCustomNotag::pack_z(int n)
{
  double **x = atom->x;
...
void DumpCustomNotag::pack_xs(int n)
{
  double **x = atom->x;
...
void DumpCustomNotag::pack_ys(int n)
{
  double **x = atom->x;
...
void DumpCustomNotag::pack_zs(int n)
{
  double **x = atom->x;
...
void DumpCustomNotag::pack_xs_triclinic(int n)
{
  int j;
  double **x = atom->x;
...
void DumpCustomNotag::pack_ys_triclinic(int n)
{
  int j;
  double **x = atom->x;
...
void DumpCustomNotag::pack_zs_triclinic(int n)
{
  double **x = atom->x;
...
void DumpCustomNotag::pack_xu(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpCustomNotag::pack_yu(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpCustomNotag::pack_zu(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpCustomNotag::pack_xu_triclinic(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpCustomNotag::pack_yu_triclinic(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpCustomNotag::pack_zu_triclinic(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpCustomNotag::pack_xsu(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpCustomNotag::pack_ysu(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpCustomNotag::pack_zsu(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpCustomNotag::pack_xsu_triclinic(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpCustomNotag::pack_ysu_triclinic(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpCustomNotag::pack_zsu_triclinic(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpCustomNotag::pack_ix(int n)
{
  imageint *image = atom->image;
...
void DumpCustomNotag::pack_iy(int n)
{
  imageint *image = atom->image;
...
void DumpCustomNotag::pack_iz(int n)
{
  imageint *image = atom->image;
...
void DumpCustomNotag::pack_vx(int n)
{
  double **v = atom->v;
...
void DumpCustomNotag::pack_vy(int n)
{
  double **v = atom->v;
...
void DumpCustomNotag::pack_vz(int n)
{
  double **v = atom->v;
...
void DumpCustomNotag::pack_fx(int n)
{
  double **f = atom->f;
...
void DumpCustomNotag::pack_fy(int n)
{
  double **f = atom->f;
...
void DumpCustomNotag::pack_fz(int n)
{
  double **f = atom->f;
...
void DumpCustomNotag::pack_q(int n)
{
  double *q = atom->q;
...
void DumpCustomNotag::pack_mux(int n)
{
  double **mu = atom->mu;
...
void DumpCustomNotag::pack_muy(int n)
{
  double **mu = atom->mu;
...
void DumpCustomNotag::pack_muz(int n)
{
  double **mu = atom->mu;
...
void DumpCustomNotag::pack_mu(int n)
{
  double **mu = atom->mu;
...
void DumpCustomNotag::pack_radius(int n)
{
  double *radius = atom->radius;
...
void DumpCustomNotag::pack_diameter(int n)
{
  double *radius = atom->radius;
...
void DumpCustomNotag::pack_omegax(int n)
{
...
void DumpCustomNotag::pack_omegay(int n)
{
  double **omega = atom->omega;
...
void DumpCustomNotag::pack_omegaz(int n)
{
  double **omega = atom->omega;
...
void DumpCustomNotag::pack_angmomx(int n)
{
...
void DumpCustomNotag::pack_angmomy(int n)
{
  double **angmom = atom->angmom;
...
void DumpCustomNotag::pack_angmomz(int n)
{
  double **angmom = atom->angmom;
...
void DumpCustomNotag::pack_tqx(int n)
{
...
void DumpCustomNotag::pack_tqy(int n)
{
  double **torque = atom->torque;
...
void DumpCustomNotag::pack_tqz(int n)
{
  double **torque = atom->torque;
