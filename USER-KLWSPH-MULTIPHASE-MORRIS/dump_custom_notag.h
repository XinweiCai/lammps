...
DumpStyle(customnotag,DumpCustomNotag)

#else

#ifndef LMP_DUMP_CUSTOM_NOTAG_H
#define LMP_DUMP_CUSTOM_NOTAG_H

#include "dump.h"

namespace LAMMPS_NS {

class DumpCustomNotag : public Dump {
 public:
  DumpCustomNotag(class LAMMPS *, int, char **);
  virtual ~DumpCustomNotag();
 ...
 protected:
  ...
  typedef void (DumpCustomNotag::*FnPtrHeader)(bigint);
  ...
  typedef void (DumpCustomNotag::*FnPtrPack)(int);
