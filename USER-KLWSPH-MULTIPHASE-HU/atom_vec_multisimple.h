...
AtomStyle(multisimple,AtomVecMultisimple)

#else

#ifndef LMP_ATOM_VEC_Multisimple_H
#define LMP_ATOM_VEC_Multisimple_H

#include "atom_vec.h"

namespace LAMMPS_NS {

class AtomVecMultisimple : public AtomVec {
 public:
  struct Bonus {
    double length,theta;
    int ilocal;
  ...
  AtomVecMultisimple(class LAMMPS *);
  ~AtomVecMultisimple();
  void init();
  void grow(int);
  void grow_reset();
