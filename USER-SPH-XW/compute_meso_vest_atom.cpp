...
#include "compute_meso_vest_atom.h"
#include <math.h>
#include <cstring>
#include "atom.h"
#include "update.h"
...
ComputeMesoVestAtom::ComputeMesoVestAtom(LAMMPS *lmp, int narg, char **arg) :
...
ComputeMesoVestAtom::~ComputeMesoVestAtom()
{
...
void ComputeMesoVestAtom::compute_peratom()
{
...
double ComputeMesoVestAtom::memory_usage()
{
