...
PairSPHRhorigid::PairSPHRhorigid(LAMMPS *lmp) : Pair(lmp)
{
  restartinfo = 0;
...
PairSPHRhorigid::~PairSPHRhorigid() {
  if (allocated) {
...
void PairSPHRhorigid::init_style() {
...
void PairSPHRhorigid::compute(int eflag, int vflag) {
...
void PairSPHRhorigid::settings(int narg, char **arg) {
...
void PairSPHRhorigid::coeff(int narg, char **arg) {
  if (narg != 4)
...
double PairSPHRhorigid::init_one(int i, int j) {
  if (setflag[i][j] == 0) {
...
double PairSPHRhorigid::single(int i, int j, int itype, int jtype, double rsq,
...
int PairSPHRhorigid::pack_forward_comm(int n, int *list, double *buf,
...
void PairSPHRhorigid::unpack_forward_comm(int n, int first, double *buf) {
  int i, m, last;
  double *rho = atom->rho;
  double **vv = atom->vv;
  m = 0;
